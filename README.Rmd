...
If you're interested in a detailed access type (differentiating between Closed Access and Open Archive, for example), use this:

```{r what_access, cache=TRUE}
what_access("10.1093/nar/gkac882")
```

## Verified journals

The following journals were validated against the solution and are confirmed to be supported. Any source not specified here is not supported, usually due to not having evaluated the journal yet.
